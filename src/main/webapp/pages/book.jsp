...
<head>
    ...
    <meta property="og:title" content="${book.getName()}">
            ...
            <div class="contentik">
                ...
                <div class="speedbar">
                    <div class="over"><span id="dle-speedbar"><span itemscope=""
                            ...
                            itemprop="title">Главная</span></a></span> » <span itemscope=""
                                                                               itemtype="http://data-vocabulary.org/Breadcrumb"><a
                            href="catalog?genre_id=${book.getGenre().getId()}" itemprop="url"><span itemprop="title">${book.getGenre().getGenre()}</span></a></span> » ${book.getName()}</span>
                    </div>
                </div>
                ...
                <div id="dle-content">
                    <article class="fiuurkrk" itemprop="mainEntity" itemscope="" itemtype="http://schema.org/Book">
                        <c:if test="${book_edit_success}">
                            <font color="green">Книга успешно отредактирована!</font>
                        </c:if>
                        <c:if test="${book_reservation_success!=null}">
                            <c:if test="${book_reservation_success==1}">
                                <font color="green">Книга успешно забронирована!</font>
                            </c:if>
                            <c:if test="${book_reservation_success==0}">
                                <font color="red">Забронировать книгу не удалось. Возможно, она уже забронирована Вами!</font>
                            </c:if>
                        </c:if>
                        ...
                        <h1>${book.getName()}
                            ...
                            <c:if test="${book.getAmount()>0}">
                                <c:if test="${!admin}">
                                    <form class="btn" action="bookReservation" method="post">
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        <button type="submit" class="btn btn-big" name="submit"
                                                title="Редактировать">Забронировать
                            ...
                            <% } %>
                            <c:if test="${admin}">
                                <form class="btn" action="bookEditing" method="post">
                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                    <button type="submit" class="btn btn-big" name="submit"
                                ...
                                <form class="btn" action="bookDeleting" method="post">
                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                    <button type="submit" class="btn btn-big" name="submit"
                        ...
                        <div class="cols-mov clearfix ignore-select">
                            <div class="col-mov-left">
                                <div class="mov-img">
                                    <a
                                        href="${book.getImageLink()}"
                                        class="highslide" target="_blank"><img itemprop="image"
                                                                               src="${book.getImageLink()}"
                            ...
                            <div class="col-mov-right">
                                <ul class="mov-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="mov-desc" itemprop="copyrightYear">
                                            ${book.getYear()}
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mov-desc" itemprop="name">
                                            ${book.getName()}
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mov-desc" itemprop="author">
                                            <a href="author?author_id=${book.getAuthor().getId()}">
                                    ...
                                    <li>
                                        ...
                                        <div class="mov-desc" itemprop="genre">
                                            <a href="catalog?genre_id=${book.getGenre().getId()}">${book.getGenre().getGenre()}</a>
                                            </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mov-desc rating_micro">
                                            ${book.getMark()}
                                        </div>
                                    </li>
                            ...
                            <div class="box">
                                ...
                                <div class="com_list">
                                    <div id="dle-ajax-comments">
                                        <div id="blind-animation" style="">
                                            <c:forEach items="${book.getReviews()}" var="review">
                                            <div id="comment-id-${review.getId()}">
                                                <div class="comment" id="--">
                                                    <div class="com_info">

                                                        <div class="com_user">
                                                            <b class="name">${review.getUser().getUsername()}</b>
                                                    ...
                                                    <div id="ratig-layer-1830">
                                                        <div class="rating">
                                                            <ul class="unit-rating">
                                                                <li class="current-rating" style="width: calc(${review.getMark()}*20%)">${review.getMark()}*20</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <br>
                                    ...
                                    <% if (session.getAttribute("user")!=null) { %>
                                    <form action="addReview" method="post" name="dle-comments-form" id="dle-comments-form">
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        <input type="hidden" name="book_id" value="${book.getId()}">
                                        <div class="mb30">
                                            <div style="font-weight: 700;font-size: 17px; margin-bottom: 22px;">Оставить
                                                комментарий
                                            </div>


                                            <div class="combo_field">
                                                <div class="rating_panel" style=" margin-left: -6px;">
                                                    <div id="ratig-layer-18" class="ratig-layer">
                                                        <div class="rating" itemprop="aggregateRating" itemscope=""
                                                             itemtype="http://schema.org/AggregateRating">
                                                            <ul class="unit-rating">
                                                                <li id="star" class="current-rating" style="width:0%;">0</li>
                                                                <li>
                                                                    <a id="star1" href="javascript:void(0);"
                                                                       rel="nofollow" title="Плохо" class="r1-unit">
                                                                        1
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a id="star2" href="javascript:void(0);"
                                                                       rel="nofollow" title="Приемлемо" class="r2-unit">
                                                                        2
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a id="star3" href="javascript:void(0);"
                                                                       rel="nofollow" title="Средне" class="r3-unit">
                                                                        3
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a id="star4" href="javascript:void(0);"
                                                                       rel="nofollow" title="Хорошо" class="r4-unit">
                                                                        4
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a id="star5" href="javascript:void(0);"
                                                                       rel="nofollow" title="Отлично" class="r5-unit"
                                                                       onclick="">
                                                                        5
                                                                    </a>
                                                                </li>
                                                                <input id="mark" type="hidden" name="mark" value="3">
                                                                <script>
                                                                    document.getElementById("star1").onclick = function () {doRate(1)};
                                                                    document.getElementById("star2").onclick = function () {doRate(2)};
                                                                    document.getElementById("star3").onclick = function () {doRate(3)};
                                                                    document.getElementById("star4").onclick = function () {doRate(4)};
                                                                    document.getElementById("star5").onclick = function () {doRate(5)};

                                                                    function doRate(id) {
                                                                        var star = document.getElementById("star");
                                                                        id = id*20;
                                                                        star.setAttribute("style", "width:"+id+"%");
                                                                        id = id/20;
                                                                        document.getElementById("mark").setAttribute("value", id)

                                                                    }
                                                                </script>

                                                            </ul>
                                                            <meta itemprop="itemReviewed" content="Неприступные стены">
                                            ...
                                            <textarea name="comments" id="comments" placeholder="Текст отзыва"
                                                      style=" margin-bottom: 15px;"></textarea>

                                            <div class="form_submit">
                                                <button class="btn btn-big" type="submit" name="submit"
                                                        title="Отправить комментарий">Отправить
                                                </button>
                                            </div>
                                        </div>
