            ...
            <div class="contentik">
                ...
                <div class="speedbar">
                    <div class="over"><span id="dle-speedbar"><span itemscope=""
                            ...
                            itemprop="title">Главная</span></a></span>  » Добавление книги</span>
                    ...
                    <article class="fiuurkrk" itemprop="mainEntity" itemscope="" itemtype="http://schema.org/Book">
                        ...
                        <form action="addBook" method="post">
                            ...
                            <div class="combo_field">
                                <input type="text" placeholder="Название книги" class="wide" name="name" required>
                            </div>
                            <div class="combo_field">
                                <input type="text" placeholder="Ссылка на фотографию" class="wide" name="image_link">
                            </div>
                            <div class="combo_field">
                                <input type="text" placeholder="Год" class="wide" name="year">
                            </div>

                            <div class="combo_field">
                                Жанр:
                                <select id="genres" required class="wide" name="genre_id">
                                    <option value="1">Любовные романы</option>
                                    <option value="2">Фантастика и фэнтези</option>
                                    <option value="3">Приключения</option>
                                    <option value="4">Детективы и триллеры</option>
                                    <option value="5">Наука, Образование</option>
                                    <option value="7">Проза</option>
                                    <option value="10">Религия и духовность</option>
                                    <option value="12">Старинная литература</option>
                                    <option value="13">Юмор</option>
                                    <option value="15">Поэзия, Драматургия</option>
                                    <option value="18">Ужасы и мистика</option>
                                    <option value="19">Сказки</option>
                                </select>
                            </div>

                            <div class="combo_field">
                                Автор:
                                <select id="authors" required class="wide" name="author_id">
