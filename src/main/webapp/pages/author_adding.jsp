            ...
            <div class="contentik">
                ...
                <div class="speedbar">
                    <div class="over"><span id="dle-speedbar"><span itemscope=""
                            ...
                            itemprop="title">Главная</span></a></span>  » Добавление автора</span>
                    ...
                    <article class="fiuurkrk" itemprop="mainEntity" itemscope="" itemtype="http://schema.org/Book">
                        ...
                        <form action="addAuthor" method="post">
                            ...
                            <div class="combo_field">
                                <input type="text" placeholder="Имя автора" class="wide" name="name" required>
                            </div>
                            <div class="combo_field">
                                <textarea class="wide" name="biography" placeholder="Биография"></textarea>
                            </div>
                            <div class="combo_field">
                                Дата рождения (не обязательно):
                                <input type="date" placeholder="Дата рождения (не обязательно)" class="wide" name="date_of_birth">
                            </div>
                            <div class="combo_field">
                                Дата смерти (не обязательно):
                                <input type="date" placeholder="Дата смерти (не обязательно)" class="wide" name="date_of_death">
                            </div>
